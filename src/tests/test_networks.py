...
def test_qnetwork_forward_lstm():
    lstm_network = QNetwork(observation_space=9, action_space=3, hidden_dim=32, linear=False)
...
def test_ddqnagent_initialization(mock_agent, mock_env):
    ...
    assert mock_agent.observation_space == mock_env.observation_space.shape[0] * mock_env.observation_space.shape[1]
